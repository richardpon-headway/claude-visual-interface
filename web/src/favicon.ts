...
// disk; both the plain and badged variants are synthesized from the same base
// markup so the badge stays visually consistent with the shipped
...
// A red dot with a light ring, tucked into the top-right corner so it reads over
// both the green icon field and light/dark browser tab bars.
...
// Show or hide the turn-end badge on the tab favicon.
export function setFaviconBadge(active: boolean): void {
